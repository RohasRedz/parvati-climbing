...
export const config = {
  ...
  content: {
    mission: 'To empower marginalized communities in the Parvati Valley through skills, education and sustainable development, while nurturing stewardship for people and the environment.',
    vision: 'A thriving Parvati Valley where community development, opportunity and environmental care move forward together.',
    impact: 'Climbing as a Force for Change',
    heroTagline: 'Harnessing outdoor skills to drive education, health, livelihoods and environmental stewardship — development first, sport as the catalyst.'
  },
