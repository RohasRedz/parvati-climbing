      ...
      <section className="parallax__header">
        <div className="parallax__visuals">
          ...
          <div data-parallax-layers className="parallax__layers">
            ...
            />
            <img 
              src="https://images.unsplash.com/photo-1464822759844-d150baec93d5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" 
              loading="eager" 
              width="800" 
            ...
            <div data-parallax-layer="3" className="parallax__layer-title">
              <h2 className="parallax__title">Climbing for Change</h2>
            </div>
            <img 
    ...
    <>
      ...
      <div className="osmo-credits">
        <p className="osmo-credits__p">
          Resource by <a target="_blank" href="https://www.osmo.supply/" className="osmo-credits__p-a">Osmo</a>
        </p>
      </div>
    </>
  );
